...
function updateAfterSearch(){
	...
	if(searchResults.length === 0) {
		listDiv.innerHTML = `
			<div style="border: 1px solid black; border-radius: 10px; padding: 20px; margin-left: 20%; margin-right: 20%; box-shadow: 5px 5px 5px 0px rgba(0,0,0,0.3);">
				<img width='80' height='80' src='req_error.jpg' alt='No results found'/>
